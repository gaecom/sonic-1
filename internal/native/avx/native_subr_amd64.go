...
var (
    ...
    _subr__skip_array   = __native_entry__() + 17465
    _subr__skip_number  = __native_entry__() + 20583
    _subr__skip_object  = __native_entry__() + 17502
    _subr__skip_one     = __native_entry__() + 15613
    _subr__u64toa       = __native_entry__() + 3735
    _subr__unquote      = __native_entry__() + 6005
    _subr__validate_one = __native_entry__() + 20700
    _subr__value        = __native_entry__() + 10880
    _subr__vnumber      = __native_entry__() + 13771
    _subr__vsigned      = __native_entry__() + 15085
    _subr__vstring      = __native_entry__() + 12736
    _subr__vunsigned    = __native_entry__() + 15344
)
