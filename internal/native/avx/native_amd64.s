...
LBB2_5:
	...
	MOVQ    R12, AX
	SHLQ    $4, AX
	LONG    $0xfb0d8d48; WORD $0x007d; BYTE $0x00 // leaq         $32251(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(AX)(CX*1), R10
	MOVQ    8(AX)(CX*1), R14
...
LBB2_12:
	...
	MOVLQSX AX, SI
	SHLQ    $4, SI
	LONG    $0x26158d4c; WORD $0x0092; BYTE $0x00 // leaq         $37414(%rip), %r10  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(SI)(R10*1), R14
	MOVQ    R14, AX
...
LBB2_61:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x00478de8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_66:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0xf8058d48; WORD $0x00a0; BYTE $0x00 // leaq         $41208(%rip), %rax  /* _Digits(%rip) */
...
LBB2_70:
	...
	JL      LBB2_85
	MOVLQSX R14, AX
	LONG    $0x8a0d8d48; WORD $0x00a0; BYTE $0x00 // leaq         $41098(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_74:
	...
	ADDQ  -64(BP), SI
	MOVL  R15, DX
	LONG  $0x004689e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R13, R13
	JE    LBB2_78
	LEAL  0(R13)(BX*1), AX
	CMPL  R13, R15
...
LBB2_105:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x004377e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0x4c0d8d48; WORD $0x009c; BYTE $0x00 // leaq         $40012(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0x2b358d48; WORD $0x009c; BYTE $0x00 // leaq         $39979(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	INCL    CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0x1a158d48; WORD $0x009c; BYTE $0x00 // leaq         $39962(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	INCL CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0x02158d48; WORD $0x009c; BYTE $0x00 // leaq         $39938(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	INCL    CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0x6b058d48; WORD $0x009b; BYTE $0x00 // leaq         $39787(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0x46358d48; WORD $0x009b; BYTE $0x00 // leaq         $39750(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	INCL CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0x35058d48; WORD $0x009b; BYTE $0x00 // leaq         $39733(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	INCL CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0x1b358d48; WORD $0x009b; BYTE $0x00 // leaq         $39707(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DX)(DI*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0x90158d48; WORD $0x009a; BYTE $0x00 // leaq         $39568(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA   LBB4_22
	MOVL DX, AX
	LONG $0x730d8d48; WORD $0x0099; BYTE $0x00 // leaq         $39283(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0x220d8d48; WORD $0x0099; BYTE $0x00 // leaq         $39202(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0xff058d4c; WORD $0x0098; BYTE $0x00 // leaq         $39167(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
_quote:
	...
	MOVQ  DX, R10
	TESTB $1, R8
	LONG  $0x01058d48; WORD $0x0099; BYTE $0x00 // leaq         $39169(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0xfa158d48; WORD $0x00a8; BYTE $0x00 // leaq         $43258(%rip), %rdx  /* __DoubleQuoteTab(%rip) */
...
LBB5_10:
	...
	MOVQ  -48(BP), CX
	MOVQ  -56(BP), DI
	LONG  $0xaf2d8d4c; WORD $0x0097; BYTE $0x00 // leaq         $38831(%rip), %r13  /* __SingleQuoteTab(%rip) */
	JLE   LBB5_39
...
_unquote:
	...
	MOVL  R8, R10
	ANDL  $1, R10
	LONG  $0xd0058d4c; WORD $0x00b4; BYTE $0x00 // leaq         $46288(%rip), %r8  /* __UnquoteTab(%rip) */
...
_html_escape:
	...
	LONG  $0x371d8d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44343(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	MOVQ  -48(BP), R15
	MOVQ  -56(BP), R10
...
LBB8_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0x693d8d4c; WORD $0x0031; BYTE $0x00 // leaq         $12649(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB9_7:
	...
	MOVQ R12, DI
	MOVL BX, SI
	LONG $0x002eb4e8; BYTE $0x00 // callq        _right_shift
...
LBB9_9:
	...
	JG   LBB9_11
	MOVL AX, AX
	LONG $0x650d8d48; WORD $0x005b; BYTE $0x00 // leaq         $23397(%rip), %rcx  /* _POW_TAB(%rip) */
	MOVL 0(CX)(AX*4), R14
...
LBB9_15:
	MOVQ R12, DI
	MOVL $60, SI
	LONG $0x002e62e8; BYTE $0x00 // callq        _right_shift
	LEAL 60(BX), AX
	CMPL BX, $-120
	MOVL AX, BX
	JL   LBB9_15
...
LBB9_17:
	MOVQ R12, DI
	MOVL $60, SI
	LONG $0x002cd4e8; BYTE $0x00 // callq        _left_shift
	LEAL -60(BX), SI
	CMPL BX, $120
	MOVL SI, BX
	JG   LBB9_17
...
LBB9_19:
	MOVQ R12, DI
	LONG $0x002cbee8; BYTE $0x00 // callq        _left_shift
	JMP  LBB9_8

LBB9_20:
	MOVQ R12, DI
	LONG $0x002cb1e8; BYTE $0x00 // callq        _left_shift
...
LBB9_26:
	NEGL AX
	WORD $0x9848                               // cltq
	LONG $0xbf0d8d48; WORD $0x005a; BYTE $0x00 // leaq         $23231(%rip), %rcx  /* _POW_TAB(%rip) */
	MOVL 0(CX)(AX*4), R14
...
LBB9_32:
	MOVQ R12, DI
	MOVL $60, SI
	LONG $0x002c4ce8; BYTE $0x00 // callq        _left_shift
	LEAL -60(BX), SI
	CMPL BX, $120
	MOVL SI, BX
	JG   LBB9_32
...
LBB9_34:
	MOVQ R12, DI
	MOVL $60, SI
	LONG $0x002d99e8; BYTE $0x00 // callq        _right_shift
	LEAL 60(BX), AX
	CMPL BX, $-120
	MOVL AX, BX
	JL   LBB9_34
...
LBB9_35:
	...
	MOVQ R12, DI
	MOVL BX, SI
	LONG $0x002d83e8; BYTE $0x00 // callq        _right_shift
	JMP  LBB9_21
...
LBB9_40:
	MOVQ R12, DI
	MOVL $60, SI
	LONG $0x002d4ce8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R15
	CMPL R15, $-120
	JL   LBB9_40
	ADDL $60, R15
...
LBB9_46:
	...
	MOVQ R12, DI
	MOVL R15, SI
	LONG $0x002d06e8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB9_47:
	...
	MOVQ R12, DI
	MOVL $53, SI
	LONG $0x002b7ce8; BYTE $0x00 // callq        _left_shift
...
_value:
	...
	MOVQ    SI, -56(BP)
	LEAQ    -40(BP), DX
	LONG    $0x0004f9e8; BYTE $0x00               // callq        _advance_ns
	MOVBLSX AX, AX
	CMPL    AX, $125
	JA      LBB11_11
	LONG    $0xae0d8d48; WORD $0x0002; BYTE $0x00 // leaq         $686(%rip), %rcx  /* LJTI11_0(%rip) */
...
LBB11_2:
	...
	LEAQ  -40(BP), SI
	MOVQ  R14, DX
	LONG  $0x000adfe8; BYTE $0x00 // callq        _vnumber
	MOVQ  -40(BP), R12
	JMP   LBB11_29
...
LBB11_7:
	MOVQ  BX, DI
	MOVQ  R12, SI
	LONG  $0x0020c8e8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB11_46
...
LBB11_12:
	...
	LEAQ  -48(BP), DX
	MOVQ  BX, SI
	LONG  $0x0006d2e8; BYTE $0x00 // callq        _advance_string
	TESTQ AX, AX
	JS    LBB11_32
	MOVQ  AX, -40(BP)
	MOVQ  BX, 16(R14)
...
LJTI11_0:
	LONG $0xfffffdcd // .long L11_0_set_10
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	...
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffdf0 // .long L11_0_set_12
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	...
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffe43 // .long L11_0_set_14
	LONG $0xfffffd5b // .long L11_0_set_2
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffd5b // .long L11_0_set_2
	LONG $0xfffffd5b // .long L11_0_set_2
	...
	LONG $0xfffffd5b // .long L11_0_set_2
	LONG $0xfffffd5b // .long L11_0_set_2
	LONG $0xfffffe51 // .long L11_0_set_15
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	...
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffe5f // .long L11_0_set_16
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffe6f // .long L11_0_set_17
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	...
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffe7d // .long L11_0_set_18
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	...
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffead // .long L11_0_set_21
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffede // .long L11_0_set_23
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xfffffeff // .long L11_0_set_26
	LONG $0xfffffddd // .long L11_0_set_11
	LONG $0xffffff0f // .long L11_0_set_27
...
LBB15_60:
	...
	MOVL  R9, DX
	MOVL  R9, -56(BP)
	LONG  $0xffeb07e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB15_64
	MOVQ  -72(BP), SI
	MOVL  -56(BP), DX
	...
	LEAQ  -64(BP), CX
	MOVQ  R12, DI
	LONG  $0xffeae3e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB15_64
...
LBB15_64:
	...
	MOVQ -88(BP), DX
	MOVQ -80(BP), CX
	LONG $0xffef8fe8; BYTE $0xff // callq        _atof_native
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+17465(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_number:
	MOVQ s+0(FP), DI
	MOVQ p+8(FP), SI
	CALL ·__native_entry__+20583(SB) // _skip_number
	MOVQ AX, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+17502(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+15613(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+20700(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+13771(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15085(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+12736(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15344(SB), AX // _vunsigned
	JMP  AX
