...
LBB2_5:
	...
	MOVQ    R12, AX
	SHLQ    $4, AX
	LONG    $0xd90d8d48; WORD $0x008e; BYTE $0x00 // leaq         $36569(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(AX)(CX*1), R10
	MOVQ    8(AX)(CX*1), R14
...
LBB2_12:
	...
	MOVLQSX AX, SI
	SHLQ    $4, SI
	LONG    $0x04158d4c; WORD $0x00a3; BYTE $0x00 // leaq         $41732(%rip), %r10  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(SI)(R10*1), R14
	MOVQ    R14, AX
...
LBB2_61:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x00586be8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_66:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0xd6058d48; WORD $0x00b1; BYTE $0x00 // leaq         $45526(%rip), %rax  /* _Digits(%rip) */
...
LBB2_70:
	...
	JL      LBB2_85
	MOVLQSX R14, AX
	LONG    $0x680d8d48; WORD $0x00b1; BYTE $0x00 // leaq         $45416(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_74:
	...
	ADDQ  -64(BP), SI
	MOVL  R15, DX
	LONG  $0x005767e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R13, R13
	JE    LBB2_78
	LEAL  0(R13)(BX*1), AX
	CMPL  R13, R15
...
LBB2_105:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x005455e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
LBB4_6:
	LONG $0xf8158d48; WORD $0x00ac; BYTE $0x00 // leaq         $44280(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	INCL CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0xe0158d48; WORD $0x00ac; BYTE $0x00 // leaq         $44256(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	INCL    CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0x49058d48; WORD $0x00ac; BYTE $0x00 // leaq         $44105(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_14:
	LONG $0x13058d48; WORD $0x00ac; BYTE $0x00 // leaq         $44051(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	INCL CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0xf9358d48; WORD $0x00ab; BYTE $0x00 // leaq         $44025(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DX)(DI*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0x6c158d48; WORD $0x00ab; BYTE $0x00 // leaq         $43884(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA   LBB4_22
	MOVL DX, AX
	LONG $0x4f0d8d48; WORD $0x00aa; BYTE $0x00 // leaq         $43599(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0xfe0d8d48; WORD $0x00a9; BYTE $0x00 // leaq         $43518(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0xdb058d4c; WORD $0x00a9; BYTE $0x00 // leaq         $43483(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
_quote:
	...
	MOVQ  CX, R15
	TESTB $1, R8
	LONG  $0x7b058d48; WORD $0x00a9; BYTE $0x00 // leaq         $43387(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0x74158d4c; WORD $0x00b9; BYTE $0x00 // leaq         $47476(%rip), %r10  /* __DoubleQuoteTab(%rip) */
	LONG  $0xd0440f4c                           // cmoveq       %rax, %r10
	MOVQ  DX, R8
	MOVQ  DI, AX
	TESTQ SI, SI
...
LBB5_26:
	TESTQ BX, BX
	MOVQ  -48(BP), R15
	LONG  $0x3f0d8d4c; WORD $0x00a6; BYTE $0x00 // leaq         $42559(%rip), %r9  /* __SingleQuoteTab(%rip) */
	JLE   LBB5_31
	TESTQ SI, SI
	JLE   LBB5_31
...
LBB6_26:
	ADDQ    BX, AX
	MOVBLZX -1(R9), CX
	LONG    $0x0b1d8d48; WORD $0x00c1; BYTE $0x00 // leaq         $49419(%rip), %rbx  /* __UnquoteTab(%rip) */
	MOVB    0(CX)(BX*1), BX
	CMPB    BX, $-1
	JE      LBB6_29
	TESTB   BX, BX
...
_html_escape:
	...
	LONG  $0xce358d4c; WORD $0x00b9; BYTE $0x00 // leaq         $47566(%rip), %r14  /* __HtmlQuoteTab(%rip) */
	MOVQ  $12884901889, DI
	MOVQ  -48(BP), R12
	MOVQ  -56(BP), R15
...
LBB8_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0xed3d8d4c; WORD $0x003a; BYTE $0x00 // leaq         $15085(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB9_5:
	...
	JLE   LBB9_20
	XORL  R15, R15
	LONG  $0xdc2d8d4c; WORD $0x0064; BYTE $0x00 // leaq         $25820(%rip), %r13  /* _POW_TAB(%rip) */
	JMP   LBB9_9
...
LBB9_7:
	...
	MOVQ R12, DI
	MOVL BX, SI
	LONG $0x0037f9e8; BYTE $0x00 // callq        _right_shift
...
LBB9_15:
	MOVQ R12, DI
	MOVL $60, SI
	LONG $0x0037b1e8; BYTE $0x00 // callq        _right_shift
	LEAL 60(BX), AX
	CMPL BX, $-120
	MOVL AX, BX
	JL   LBB9_15
...
LBB9_17:
	MOVQ R12, DI
	MOVL $60, SI
	LONG $0x003623e8; BYTE $0x00 // callq        _left_shift
	LEAL -60(BX), SI
	CMPL BX, $120
	MOVL SI, BX
	JG   LBB9_17
...
LBB9_19:
	MOVQ R12, DI
	LONG $0x00360de8; BYTE $0x00 // callq        _left_shift
	JMP  LBB9_8

LBB9_20:
	LONG $0x48358d4c; WORD $0x0064; BYTE $0x00 // leaq         $25672(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB9_23

LBB9_21:
	MOVQ R12, DI
	LONG $0x0035fae8; BYTE $0x00 // callq        _left_shift
...
LBB9_33:
	MOVQ R12, DI
	MOVL $60, SI
	LONG $0x00359fe8; BYTE $0x00 // callq        _left_shift
	LEAL -60(BX), SI
	CMPL BX, $120
	MOVL SI, BX
	JG   LBB9_33
...
LBB9_35:
	MOVQ R12, DI
	MOVL $60, SI
	LONG $0x0036ece8; BYTE $0x00 // callq        _right_shift
	LEAL 60(BX), AX
	CMPL BX, $-120
	MOVL AX, BX
	JL   LBB9_35
...
LBB9_36:
	...
	MOVQ R12, DI
	MOVL BX, SI
	LONG $0x0036d6e8; BYTE $0x00 // callq        _right_shift
	JMP  LBB9_22
...
LBB9_41:
	MOVQ R12, DI
	MOVL $60, SI
	LONG $0x003695e8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R15
	CMPL R15, $-120
	JL   LBB9_41
	ADDL $60, R15
...
LBB9_47:
	...
	MOVQ R12, DI
	MOVL R15, SI
	LONG $0x003645e8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB9_48:
	...
	MOVQ R12, DI
	MOVL $53, SI
	LONG $0x0034bbe8; BYTE $0x00 // callq        _left_shift
...
LBB11_26:
	...
	LEAQ 32(SI)(AX*1), SI
	ANDL $31, DX
	QUAD $0xfffffded056ffec5 // vmovdqu      $-531(%rip), %ymm0  /* LCPI11_0(%rip) */
	QUAD $0xfffffe050d6ffec5 // vmovdqu      $-507(%rip), %ymm1  /* LCPI11_1(%rip) */
	QUAD $0xfffffe1d156ffec5 // vmovdqu      $-483(%rip), %ymm2  /* LCPI11_2(%rip) */
	QUAD $0xfffffe351d6ffec5 // vmovdqu      $-459(%rip), %ymm3  /* LCPI11_3(%rip) */
...
LBB11_31:
	...
	LEAQ 16(SI)(AX*1), SI
	ANDL $15, DX
	QUAD $0xfffffdf0056ffac5 // vmovdqu      $-528(%rip), %xmm0  /* LCPI11_4(%rip) */
	QUAD $0xfffffdf80d6ffac5 // vmovdqu      $-520(%rip), %xmm1  /* LCPI11_5(%rip) */
	QUAD $0xfffffe00156ffac5 // vmovdqu      $-512(%rip), %xmm2  /* LCPI11_6(%rip) */
	QUAD $0xfffffe081d6ffac5 // vmovdqu      $-504(%rip), %xmm3  /* LCPI11_7(%rip) */
...
LBB11_48:
	...
	JA      LBB11_61
	LEAQ    0(R15)(AX*1), R13
	LONG    $0xa7358d48; WORD $0x0002; BYTE $0x00 // leaq         $679(%rip), %rsi  /* LJTI11_0(%rip) */
...
LBB11_58:
	MOVQ  R13, DI
	MOVQ  R14, SI
	LONG  $0x002323e8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB11_97
...
LBB11_62:
	...
	LEAQ  -56(BP), DX
	MOVQ  R12, SI
	LONG  $0x0004a6e8; BYTE $0x00 // callq        _advance_string
	TESTQ AX, AX
	JS    LBB11_81
	MOVQ  AX, -48(BP)
	MOVQ  R12, 16(BX)
...
LJTI11_0:
	LONG $0xfffffd82 // .long L11_0_set_52
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	...
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffde6 // .long L11_0_set_62
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	...
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffe35 // .long L11_0_set_64
	LONG $0xfffffd62 // .long L11_0_set_50
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffd62 // .long L11_0_set_50
	LONG $0xfffffd62 // .long L11_0_set_50
	...
	LONG $0xfffffd62 // .long L11_0_set_50
	LONG $0xfffffd62 // .long L11_0_set_50
	LONG $0xfffffe47 // .long L11_0_set_65
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	...
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffe59 // .long L11_0_set_66
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffe65 // .long L11_0_set_67
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	...
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffe77 // .long L11_0_set_68
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	...
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffea2 // .long L11_0_set_71
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffecd // .long L11_0_set_74
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xffffff08 // .long L11_0_set_78
	LONG $0xfffffddd // .long L11_0_set_61
	LONG $0xffffff14 // .long L11_0_set_79
...
LBB14_60:
	...
	MOVL  R9, DX
	MOVL  R9, -56(BP)
	LONG  $0xffe89fe8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB14_64
	MOVQ  -72(BP), SI
	MOVL  -56(BP), DX
	...
	LEAQ  -64(BP), CX
	MOVQ  R12, DI
	LONG  $0xffe87be8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB14_64
...
LBB14_64:
	...
	MOVQ -88(BP), DX
	MOVQ -80(BP), CX
	LONG $0xffef51e8; BYTE $0xff // callq        _atof_native
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+21484(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_number:
	MOVQ s+0(FP), DI
	MOVQ p+8(FP), SI
	CALL ·__native_entry__+25132(SB) // _skip_number
	MOVQ AX, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+21521(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18384(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+25249(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+16542(SB), AX // _vnumber
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15665(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18115(SB), AX // _vunsigned
	JMP  AX
