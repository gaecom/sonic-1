...
var (
    ...
    _subr__skip_array   = __native_entry__() + 21484
    _subr__skip_number  = __native_entry__() + 25132
    _subr__skip_object  = __native_entry__() + 21521
    _subr__skip_one     = __native_entry__() + 18384
    _subr__u64toa       = __native_entry__() + 4008
    _subr__unquote      = __native_entry__() + 7080
    _subr__validate_one = __native_entry__() + 25249
    _subr__value        = __native_entry__() + 13781
    _subr__vnumber      = __native_entry__() + 16542
    _subr__vsigned      = __native_entry__() + 17856
    _subr__vstring      = __native_entry__() + 15665
    _subr__vunsigned    = __native_entry__() + 18115
)
